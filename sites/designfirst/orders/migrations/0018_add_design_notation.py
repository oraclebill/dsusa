...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RequestNotation'
        db.create_table('orders_requestnotation', (
            ('id', orm['orders.requestnotation:id']),
            ('author', orm['orders.requestnotation:author']),
            ('order', orm['orders.requestnotation:order']),
            ('note_text', orm['orders.requestnotation:note_text']),
            ('created', orm['orders.requestnotation:created']),
            ('area_reference', orm['orders.requestnotation:area_reference']),
            ('field_reference', orm['orders.requestnotation:field_reference']),
        ))
        db.send_create_signal('orders', ['RequestNotation'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'RequestNotation'
        db.delete_table('orders_requestnotation')
    ...
    models = {
        ...
        'orders.designpackage': {
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'designpackage'", 'to': "orm['orders.WorkingOrder']"})
        },
        'orders.designpackagefile': {
            'design_package': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.DesignPackage']"}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'orders.requestnotation': {
            'area_reference': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'order_notes'", 'to': "orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'field_reference': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note_text': ('django.db.models.fields.TextField', [], {}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notes'", 'to': "orm['orders.WorkingOrder']"})
        },
        'orders.workingorder': {
            'account_code': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
