...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkingOrder.tracking_code'
        db.add_column('orders_workingorder', 'tracking_code', orm['orders.workingorder:tracking_code'])
        
        # Adding field 'WorkingOrder.created'
        db.add_column('orders_workingorder', 'created', models.DateTimeField(default='2 jan 0001'))
        
        # Adding field 'WorkingOrder.type'
        db.add_column('orders_workingorder', 'type', orm['orders.workingorder:type'])
        
        # Adding field 'WorkingOrder.account_code'
        db.add_column('orders_workingorder', 'account_code', orm['orders.workingorder:account_code'])
        
        # Changing field 'WorkingOrder.slide_out_trays'
        # (to signature: django.db.models.fields.CharField(max_length=15, blank=True))
        db.alter_column('orders_workingorder', 'slide_out_trays', orm['orders.workingorder:slide_out_trays'])
        
        # Changing field 'WorkingOrder.plate_rack'
        # (to signature: django.db.models.fields.CharField(max_length=15, blank=True))
        db.alter_column('orders_workingorder', 'plate_rack', orm['orders.workingorder:plate_rack'])
        
        # Changing field 'WorkingOrder.wine_rack'
        # (to signature: django.db.models.fields.CharField(max_length=15, blank=True))
        db.alter_column('orders_workingorder', 'wine_rack', orm['orders.workingorder:wine_rack'])
        
        # Changing field 'WorkingOrder.waste_bin'
        # (to signature: django.db.models.fields.CharField(max_length=15, blank=True))
        db.alter_column('orders_workingorder', 'waste_bin', orm['orders.workingorder:waste_bin'])
        
        # Changing field 'WorkingOrder.appliance_garage'
        # (to signature: django.db.models.fields.CharField(max_length=15, blank=True))
        db.alter_column('orders_workingorder', 'appliance_garage', orm['orders.workingorder:appliance_garage'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WorkingOrder.tracking_code'
        db.delete_column('orders_workingorder', 'tracking_code')
        
        # Deleting field 'WorkingOrder.created'
        db.delete_column('orders_workingorder', 'created')
        
        # Deleting field 'WorkingOrder.type'
        db.delete_column('orders_workingorder', 'type')
        
        # Deleting field 'WorkingOrder.account_code'
        db.delete_column('orders_workingorder', 'account_code')
        
        # Changing field 'WorkingOrder.slide_out_trays'
        # (to signature: django.db.models.fields.CharField(max_length=15))
        db.alter_column('orders_workingorder', 'slide_out_trays', orm['orders.workingorder:slide_out_trays'])
