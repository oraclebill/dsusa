...
class Migration:
    ...
    def forwards(self, orm):
        "Add default values for 'customer_code' where blank or null"
        # admin user is usually first.. 
        default_user  = orm['auth.user'].objects.all().order_by('id').iterator().next()
        for order in orm.WorkingOrder.objects.all():
            # ensure all orders have a valid owner, or assign a default
            if not order.owner:
    ...
    def backwards(self, orm):
        ...
        pass  # we're not going to try to unset account codes...
