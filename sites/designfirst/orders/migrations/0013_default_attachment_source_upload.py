...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attachment.source'
        # (to signature: django.db.models.fields.CharField(default='U', max_length=1))
        db.alter_column('orders_attachment', 'source', orm['orders.attachment:source'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Attachment.source'
        # (to signature: django.db.models.fields.CharField(default='F', max_length=1))
        db.alter_column('orders_attachment', 'source', orm['orders.attachment:source'])
