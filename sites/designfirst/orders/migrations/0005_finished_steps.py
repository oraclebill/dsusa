...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkingOrder.finished_steps'
        db.add_column('orders_workingorder', 'finished_steps', orm['orders.workingorder:finished_steps'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WorkingOrder.finished_steps'
        db.delete_column('orders_workingorder', 'finished_steps')
