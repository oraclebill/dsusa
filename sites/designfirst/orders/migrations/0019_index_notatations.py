...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [order, area_reference, field_reference] on RequestNotation.
        db.create_unique('orders_requestnotation', ['order_id', 'area_reference', 'field_reference'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [order, area_reference, field_reference] on RequestNotation.
        db.delete_unique('orders_requestnotation', ['order_id', 'area_reference', 'field_reference'])
    ...
    models = {
        ...
        'orders.requestnotation': {
            'Meta': {'unique_together': "(('order', 'area_reference', 'field_reference'),)"},
