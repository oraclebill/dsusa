...
class Migration:
    ...
    def forwards(self, orm):
        for page in orm.AttachPreview.objects.all():
            page = model_to_dict(page)
            page['attachment_id'] = page.pop('attachment')
            p = orm.AttachmentPage.objects.create(**page)
#        # Adding model 'AttachmentPage'
#        db.create_table('orders_attachmentpage', (
#            ('id', orm['orders.attachmentpage:id']),
#            ('attachment', orm['orders.attachmentpage:attachment']),
#            ('page', orm['orders.attachmentpage:page']),
#            ('file', orm['orders.attachmentpage:file']),
#        ))
#        db.send_create_signal('orders', ['AttachmentPage'])
#        
#        # Adding field 'Attachment.page_count'
#        db.add_column('orders_attachment', 'page_count', orm['orders.attachment:page_count'])
#        
...
#        db.delete_table('orders_attachpreview')
    ...
    def backwards(self, orm):
        for page in orm.AttachmentPage.objects.all():
            page = model_to_dict(page)
            page['attachment_id'] = page.pop('attachment')
            p = orm.AttachPreview.objects.create(**page)

#        # Deleting model 'AttachmentPage'
#        db.delete_table('orders_attachmentpage')
#        
#        # Deleting field 'Attachment.page_count'
#        db.delete_column('orders_attachment', 'page_count')
#        
#        # Adding model 'attachpreview'
#        db.create_table('orders_attachpreview', (
#            ('page', orm['orders.attachment:page']),
#            ('attachment', orm['orders.attachment:attachment']),
