...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkingOrder.project_type'
        db.add_column('orders_workingorder', 'project_type', orm['orders.workingorder:project_type'])
            
    
    def backwards(self, orm):
        
        # Deleting field 'WorkingOrder.project_type'
        db.delete_column('orders_workingorder', 'project_type')
