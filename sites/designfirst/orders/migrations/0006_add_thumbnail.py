...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AttachmentPage.thumb'
        db.add_column('orders_attachmentpage', 'thumb', orm['orders.attachmentpage:thumb'])            
    
    def backwards(self, orm):
        
        # Deleting field 'AttachmentPage.thumb'
        db.delete_column('orders_attachmentpage', 'thumb')
