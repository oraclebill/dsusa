...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkingOrder.door_style'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'door_style', orm['orders.workingorder:door_style'])
        
        # Changing field 'WorkingOrder.finish_options'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'finish_options', orm['orders.workingorder:finish_options'])
        
        # Changing field 'WorkingOrder.finish_color'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'finish_color', orm['orders.workingorder:finish_color'])
        
        # Changing field 'WorkingOrder.door_handle_model'
        # (to signature: django.db.models.fields.CharField(max_length=100, null=True, blank=True))
        db.alter_column('orders_workingorder', 'door_handle_model', orm['orders.workingorder:door_handle_model'])
        
        # Changing field 'WorkingOrder.manufacturer'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'manufacturer', orm['orders.workingorder:manufacturer'])
        
        # Changing field 'WorkingOrder.product_line'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'product_line', orm['orders.workingorder:product_line'])
        
        # Changing field 'WorkingOrder.drawer_handle_model'
        # (to signature: django.db.models.fields.CharField(max_length=100, null=True, blank=True))
        db.alter_column('orders_workingorder', 'drawer_handle_model', orm['orders.workingorder:drawer_handle_model'])
        ...
        # Changing field 'WorkingOrder.drawer_front_style'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('orders_workingorder', 'drawer_front_style', orm['orders.workingorder:drawer_front_style'])
        
        # Changing field 'WorkingOrder.cabinet_material'
        # (to signature: django.db.models.fields.CharField(max_length=20, null=True, blank=True))
        db.alter_column('orders_workingorder', 'cabinet_material', orm['orders.workingorder:cabinet_material'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WorkingOrder.cabinet_material'
        # (to signature: django.db.models.fields.CharField(max_length=10, null=True, blank=True))
        db.alter_column('orders_workingorder', 'cabinet_material', orm['orders.workingorder:cabinet_material'])
    ...
    models = {
        ...
        'orders.workingorder': {
            ...
            'cabinet_material': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'door_handle_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'door_handle_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'door_style': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'drawer_front_style': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'drawer_handle_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'finish_color': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'finish_options': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'finish_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'finished_steps': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            ...
            'product_line': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
