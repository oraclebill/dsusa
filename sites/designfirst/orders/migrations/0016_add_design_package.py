...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DesignPackageFile'
        db.create_table('orders_designpackagefile', (
            ('id', orm['orders.designpackagefile:id']),
            ('design_package', orm['orders.designpackagefile:design_package']),
            ('type', orm['orders.designpackagefile:type']),
            ('file', orm['orders.designpackagefile:file']),
        ))
        db.send_create_signal('orders', ['DesignPackageFile'])
        
        # Adding model 'DesignPackage'
        db.create_table('orders_designpackage', (
            ('id', orm['orders.designpackage:id']),
            ('order', orm['orders.designpackage:order']),
            ('created', orm['orders.designpackage:created']),
        ))
        db.send_create_signal('orders', ['DesignPackage'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'DesignPackageFile'
        db.delete_table('orders_designpackagefile')
        
        # Deleting model 'DesignPackage'
        db.delete_table('orders_designpackage')
