...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkingOrder.completed'
        db.add_column('orders_workingorder', 'completed', orm['orders.workingorder:completed'])
        
        # Changing field 'WorkingOrder.account_code'
        # (to signature: django.db.models.fields.CharField(max_length=40))
        db.alter_column('orders_workingorder', 'account_code', orm['orders.workingorder:account_code'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WorkingOrder.completed'
        db.delete_column('orders_workingorder', 'completed')
    ...
    models = {
        ...
        'orders.workingorder': {
            'account_code': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
