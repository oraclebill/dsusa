...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounting_transaction', (
            ('id', orm['accounting.Transaction:id']),
            ('trace_id', orm['accounting.Transaction:trace_id']),
            ('account', orm['accounting.Transaction:account']),
            ('debit_or_credit', orm['accounting.Transaction:debit_or_credit']),
            ('trans_type', orm['accounting.Transaction:trans_type']),
            ('amount', orm['accounting.Transaction:amount']),
            ('description', orm['accounting.Transaction:description']),
            ('timestamp', orm['accounting.Transaction:timestamp']),
        ))
